...
const MailSuccess = ({
  title="Successful!",
  heading="Your message sent successfully",
  
  bodyText="Thank you so much for your message. We check e-mail frequently and will try our best to respond to your inquiry."
}) => {
  return (
    <>
